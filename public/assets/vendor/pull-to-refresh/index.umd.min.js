...
!(function (e, t) {
    ...
    var t,
        n = {
            setupDOM: function (t) {
                if (!t.ptrElement) {
                    ...
                    t.mainElement !== document.body
                        ? t.mainElement.parentNode.insertBefore(
                              n,
                              t.mainElement
                          )
            ...
            update: function (t) {
                var n = t.ptrElement.querySelector(
                        "." + t.classPrefix + "icon"
                    ),
                    s = t.ptrElement.querySelector(
                        "." + t.classPrefix + "text"
                    );
                n &&
                    ("refreshing" === e.state
                    ...
                    "refreshing" !== e.state
                        ? ("pending" === e.state &&
                          ...
                          e.distExtra > 0 &&
                              ...
                              (r.ptrElement.style[r.cssProp] =
                                  e.distResisted + "px"),
                              (e.distResisted =
                                  r.resistanceFunction(
                                      e.distExtra / r.distThreshold
                                  ) * Math.min(r.distMax, e.distExtra)),
                              "pulling" === e.state &&
                                  e.distResisted > r.distThreshold &&
                                  (r.ptrElement.classList.add(
                                      r.classPrefix + "release"
                                  ),
                                  (e.state = "releasing"),
                                  n.update(r)),
                              "releasing" === e.state &&
                                  e.distResisted < r.distThreshold &&
                                  (r.ptrElement.classList.remove(
                                      r.classPrefix + "release"
                                  ),
                                  (e.state = "pulling"),
                                  n.update(r))))
