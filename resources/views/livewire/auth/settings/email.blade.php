<div class="px-2 py-7">
    ...
    <div class="px-7">
        <div class="mb-6 text-center">
            <div>
                <p class="mb-6 text-base text-gray-500">Harap gunakan email yang aktif, karena akan digunakan pada saat
            ...
            <div>
                ...
                <div class="text-right" x-transition x-show="$wire.email != $wire.original.email">
                    <button @click="$wire.email = $wire.original.email"
                        class="btn btn-border-warning bg-gradient-warning-soft flex-grow py-2 mr-3"> <i
                            class="bi bi-backspace-reverse-fill"></i></button>
                    <button @click="$wire.change_email()"
