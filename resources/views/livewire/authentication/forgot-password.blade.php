<div class="mx-auto p-6 md:p-12 tracking-wide-all">
    ...
    <form class="mb-6" wire:submit="send_email">
        ...
        <div>
            <button type="submit" wire:loading.class="pointer-events-none opacity-80"
                ...
                <div wire:loading.class="hidden">Kirim</div>
                <div class="hidden" wire:loading.class.remove="hidden">Loading..</div>
            </button>
        </div>
    </form>
    <p class="text-white font-light">Sudah selesai? <a href="/" class="font-bold underline hover-opacity-up">Masuk
            disini</a></p>
</div>
